 ...
 */
package com.redhat.patriot.smart_home_gateway.kjar;
...
public class LightCommand extends Command {
   ...
   public enum Place {
      JUNK(0),KITCHEN_COOK(1), KITCHEN_SINK(2), BATHROOM_TUB(3), BATHROOM_SINK(4), KITCHEN_GARDEN(5),
      KITCHEN_TABLE(6), CORRIDOR(7), ENTRANCE(8), BEDROOM(9), LIVINGROOM_FIREPLACE(10), LIVINGROOM_LIBRARY(11),
      BED_WINDOW(12), BED_WARDROBE(13), LIVINGROOM_COUCH(14), ALL(0xffff);
